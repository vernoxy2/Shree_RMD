...
const Professional = ({ HeadLine, Data = [] }) => {
  return (
    <div className="space-y-12 pb-12">
      <div data-aos="fade-up" data-aos-delay="300" className="max-w-md mx-auto bg-primary py-1 px-6 rounded-r-full w-fit relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {Data.map((item, index) => (
          <PrimaryCard index={index} key={index} {...item} />
        ))}
      </div>
    </div>
  );
